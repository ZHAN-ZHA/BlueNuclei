...
A schematic overview of the algorithmic workflow is provided in [`assets/BlueNuclei_workflow.svg`](assets/BlueNuclei_workflow.svg). Full methodological details are described in the accompanying manuscript: 
